...
const planManagementData = {
    ...
    plans: [
        ...
        },
        {
            id: 9,
            type: 'leader',
            planStartDate: '2025-08-11',
            planEndDate: '2025-08-17',
            leader: '赵司令',
            leadDept: '后勤处',
            accompanyDept: ['装备处'],
            units: ['一营', '二营', '三营', '四营', '五营'],
            actualDate: '2025-08-13',
            actualLeader: '赵司令',
            actualLeadDept: '后勤处',
            actualAccompanyDept: ['装备处'],
            actualUnits: ['一营', '二营', '三营', '四营'],
        ...
        },
        {
            id: 10,
            type: 'daily',
            planStartDate: '2025-09-29',
            planEndDate: '2025-10-05',
            inspector: '孙参谋',
            units: ['一营', '二营', '三营', '四营', '五营', '六营'],
            actualDate: null,
            actualInspector: null,
        ...
        },
        {
            id: 11,
            type: 'leader',
            planStartDate: '2025-07-21',
            planEndDate: '2025-07-27',
            leader: '周司令',
            leadDept: '训练处',
            accompanyDept: ['政治处', '后勤处'],
            units: ['一营', '二营', '三营'],
            actualDate: '2025-07-23',
            actualLeader: '周司令',
            actualLeadDept: '训练处',
            actualAccompanyDept: ['政治处', '后勤处'],
            actualUnits: ['一营', '二营', '三营'],
            checkResult: '优秀',
            status: 'completed'
        },
        {
    ...
    basicUnits: [
        {
            ...
            level: '基层',
            parentId: 13,
            hierarchy: ['陆军', '北部战区', '大连基地', '作战处', '作战处一营'],
            location: '大连市',
            distance: 15,
            personnel: 120,
            tags: ['重点单位', '训练基地']
